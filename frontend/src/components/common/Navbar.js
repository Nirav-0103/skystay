          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className={`flex items-center gap-1 pl-2 pr-6 py-1.5 rounded-lg cursor-pointer transition text-sm font-medium outline-none appearance-none ${isDark ? "bg-slate-800 hover:bg-slate-700 text-slate-200" : "bg-gray-100 hover:bg-gray-200 text-gray-700"}`}
                style={{
